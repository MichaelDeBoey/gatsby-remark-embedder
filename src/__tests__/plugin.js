...
describe('gatsby-remark-embedder', () => {
  ...
  test('can transform all supported links (kitchensink)', async () => {
    mockCache({
      ...
      'https://twitter.com/wesbos/timelines/1189618481672667136': `<a class="twitter-timeline" data-dnt="true" href="https://twitter.com/wesbos/timelines/1189618481672667136">🔥 Hot Tips from Wes Bos - Curated tweets by wesbos</a>`,
    });
    ...
    expect(parseASTToMarkdown(processedAST)).toMatchInlineSnapshot(`
      ...
      <a class=\\"twitter-timeline\\" data-dnt=\\"true\\" href=\\"https://twitter.com/wesbos/timelines/1189618481672667136\\">🔥 Hot Tips from Wes Bos - Curated tweets by wesbos</a>
